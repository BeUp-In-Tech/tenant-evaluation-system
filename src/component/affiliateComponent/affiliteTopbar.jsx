...
export default function AffiliateTopbar() {
  ...
  const handleSearch = (e) => {
    ...
    console.log('Affiliate searching for:', e.target.value);
  };

  return (
    <header className="fixed top-0 left-48 right-0 h-14 bg-white border-b border-gray-100 flex items-center px-6 gap-4 z-20">
      <div className="flex-1 relative">
        ...
        <input
          ...
          className="w-full max-w-sm pl-9 pr-4 py-2 text-[13px] bg-gray-50 border border-gray-200 rounded-lg text-gray-700 placeholder-gray-400 focus:outline-none focus:border-blue-300 focus:bg-white transition-all"
      ...
      <div className="flex items-center gap-3 ml-auto">
        {/* <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-lg px-3 py-1.5">
          ...
          <span className="text-[13px] font-semibold text-gray-800">Affiliate</span>
        ...
        <div className="flex items-center gap-2">
          <div className="text-right">
            ...
            <div className="text-[11px] text-gray-400">Affiliate</div>
          </div>
